...
let counter = document.querySelectorAll('.edit-ref').length;
const limit = 4;
...
let stepCounter = document.querySelectorAll('.edit-step').length;
const stepLimit = 8;
...
const delImgModal = document.getElementById('deleteImageModal');
const delImgForm = document.getElementById('deleteImageForm');
